...
[![Status: Active](https://img.shields.io/badge/Status-Active-green.svg)](https://github.com/nike-sb-archive/core)
[![Release](https://img.shields.io/badge/Release-v0.1.0-blue.svg)](https://github.com/nike-sb-archive/core/releases)
...
## 2. Taxonomic Tracks
* **BA2037‑089:** The “origin point” of the official RPM era.
...
* **Evidence Integrity:** Checksums and manifests protect evidence integrity.
* **Strict Naming:** `BA####-###_[viewtype]_[sequence].ext`
* **Reproducibility:** Automated scripts (`generate_master_metadata.py`) scan image files and log artifacts to a master CSV.

## 4. Citation
To cite this dataset:

> Segal, T. (2026). *Nike SB RPM Master Archive* [Data set]. Version 0.1.0. https://github.com/tamirsegal1810-byte/rpm-archive

---
*The backpack is the artifact; the archive is the machine that turns artifacts into knowledge.*
